...
const Home: NextPage = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between gap-y-56 px-36 pt-112 pb-144">
      <button className="absolute top-16 right-16 flex h-48 w-48 items-center justify-center hover:bg-white-500">
      ...
      <Link
        ...
        className="fixed bottom-24 right-24 flex h-64 w-64 items-center justify-center rounded-full bg-blue-700 duration-150 hover:bg-black"
      >
