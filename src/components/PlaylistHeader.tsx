...
export const PlaylistHeader: FC<Props> = ({ bpm, onClose, className = '' }) => {
	return (
		<header className={`flex w-screen-x gap-x-16 bg-blue-700 px-16 pb-32 pt-16 ${className}`}>
			<button type="button" onClick={onClose} className="flex size-48 items-center justify-center">
