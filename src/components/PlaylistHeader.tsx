...
export const PlaylistHeader: FC<Props> = ({ bpm, onClose }) => {
  return (
    <div className="flex w-screen-x gap-x-16 bg-blue-700 px-16 pt-16 pb-32">
      ...
      <div className="grow pt-16 text-white">
        <div className="w-64 text-center font-bold">
          <div className="text-24 leading-none tracking-0.02">BPM</div>
          <div className="font-dosis text-48 leading-none tracking-0.038">{bpm}</div>
        </div>
      </div>
    </div>
  );
